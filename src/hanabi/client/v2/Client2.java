...
import hanabi.gui.GameController;
...
public class Client2 implements IClient {
	...
	private ClientListener2 clientListener;
	...
	public void readMessage(IMessage msg) {
		...
		switch (messageType) {
		case START:
			gameController.createOtherPlayers(playerNames.size() - 1);
			break;
		case NEWCARD:
			break;
		case QUIT:
		...
		case STATUS_PLAYER_CARDS:
			gameController.updateCards(msg.getCardList(), msg.getPlayer());
	...
	public void listenToServer() {
		clientListener = new ClientListener2(this);
	...
	public void setGameController(GameController gameController) {
		System.out.println("Set Game Controller");
